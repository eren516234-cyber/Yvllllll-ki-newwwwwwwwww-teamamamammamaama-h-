    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(context, ref,
              FluentIcons.arrow_trending_24_regular, FluentIcons.arrow_trending_24_filled, "Charts", 2, selectedIndex),
          _buildNavItem(context, ref,
              FluentIcons.library_24_regular, FluentIcons.library_24_filled, "Library", 3, selectedIndex),
          _buildNavItem(context, ref,
